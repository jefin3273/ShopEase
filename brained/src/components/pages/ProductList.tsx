                ...
                >
                  ...
                  {product.badge && (
                    <div className="absolute top-3 left-3 z-10">
                      <span
                        className={`px-3 py-1 text-xs font-semibold rounded-full ${product.badge === 'Sale'
                  ...
                  <div className="absolute top-3 right-3 z-10 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button
                      ...
                      className={`p-2 rounded-full backdrop-blur-sm transition-all ${favorites.includes(product._id)
                          ? 'bg-red-500 text-white'
                    ...
                    >
                      <Heart
                        className={`w-4 h-4 ${favorites.includes(product._id) ? 'fill-current' : ''
                          }`}
                      />
                    </button>
                    <button
